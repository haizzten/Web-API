...
namespace f7.Models.Models.Migrations
{
    ...
    [Migration("20220111065215_modify Order and Staff")]
    partial class modifyOrderandStaff
    {
            ...
            modelBuilder.Entity("f7.Models.StockCardModels", b =>
                {
                    ...
                    b.HasOne("f7.Models.BatchModels", "Batch")
                        .WithMany()
                        .HasForeignKey("BatchId", "WarehouseReceiptId")
                        .HasPrincipalKey("BatchId", "WarehouseReceiptId");
